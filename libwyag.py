...
# The *path takes multiple arguments e.g path, addition path and combines it into a tuple so join can combine the entire path
...
argsp.add_argument("-w",
                   dest = "write",
                   action = "store_true",
                   help = "Writes the object into the database")
